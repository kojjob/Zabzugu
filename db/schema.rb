...
ActiveRecord::Schema[8.0].define(version: 2025_04_06_020150) do
  ...
  create_table "inventory_adjustments", force: :cascade do |t|
    ...
    t.index ["variant_id"], name: "index_inventory_adjustments_on_variant_id"
  end
  ...
  add_foreign_key "inventory_adjustments", "variants"
