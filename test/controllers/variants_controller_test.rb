...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference("Variant.count") do
      post variants_url, params: { variant: { name: @variant.name, price: @variant.price, product_id: @variant.product_id, sku: @variant.sku, stock_quantity: @variant.stock_quantity } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { name: @variant.name, price: @variant.price, product_id: @variant.product_id, sku: @variant.sku, stock_quantity: @variant.stock_quantity } }
