...
class ShippingMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping_method" do
    assert_difference("ShippingMethod.count") do
      post shipping_methods_url, params: { shipping_method: { delivery_estimate: @shipping_method.delivery_estimate, name: @shipping_method.name, provider: @shipping_method.provider } }
    end
  ...
  test "should update shipping_method" do
    patch shipping_method_url(@shipping_method), params: { shipping_method: { delivery_estimate: @shipping_method.delivery_estimate, name: @shipping_method.name, provider: @shipping_method.provider } }
